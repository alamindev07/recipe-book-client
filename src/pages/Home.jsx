...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get("https://recipe-book-server-five.vercel.app/recipes/top-liked")
  ...
  return (
    ...
    >
      ...
      <div className="text-center my-10">
        <Link
          to="/all-recipes"
          className="btn btn-outline btn-primary rounded-full bg-orange-500 text-black"
        >
          See All Recipes
        </Link>
      </div>
      ...
      <div className="my-16 text-center rounded-xl py-10 px-4 shadow-sm bg-white">
        ...
        <p className="max-w-2xl mx-auto  text-green-400">
          Recipe Book is your personal kitchen companion! Store, share, and
          discover delicious recipes from all around the world with a beautiful
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center mt-10">
        <div className="p-6 border rounded-lg shadow-sm bg-white">
          ...
          <h4 className="font-bold text-lg mb-1 text-orange-500">
            1000+ Recipes
          </h4>
          <p className="text-sm text-gray-600">
            Explore cuisines and meals from around the globe.
          </p>
        </div>
        <div className="p-6 border rounded-lg shadow-sm bg-white">
          ...
          <p className="text-sm text-gray-600">
            Like and discover the most popular recipes.
          </p>
        </div>
        <div className="p-6 border rounded-lg shadow-sm bg-white">
